...
// Defines values for OrgSettingsDateEra.
const (
	OrgSettingsDateEraBE OrgSettingsDateEra = "BE"
	OrgSettingsDateEraCE OrgSettingsDateEra = "CE"
)

// Valid indicates whether the value is a known member of the OrgSettingsDateEra enum.
func (e OrgSettingsDateEra) Valid() bool {
	switch e {
	case OrgSettingsDateEraBE:
		return true
	case OrgSettingsDateEraCE:
		return true
	default:
		return false
	}
...
// Defines values for OrgSettingsDefaultLanguage.
const (
	OrgSettingsDefaultLanguageEn OrgSettingsDefaultLanguage = "en"
	OrgSettingsDefaultLanguageTh OrgSettingsDefaultLanguage = "th"
)

// Valid indicates whether the value is a known member of the OrgSettingsDefaultLanguage enum.
func (e OrgSettingsDefaultLanguage) Valid() bool {
	switch e {
	case OrgSettingsDefaultLanguageEn:
		return true
	case OrgSettingsDefaultLanguageTh:
		return true
	default:
		return false
	}
...
// Defines values for OrgSettingsInputDateEra.
const (
	OrgSettingsInputDateEraBE OrgSettingsInputDateEra = "BE"
	OrgSettingsInputDateEraCE OrgSettingsInputDateEra = "CE"
)

// Valid indicates whether the value is a known member of the OrgSettingsInputDateEra enum.
func (e OrgSettingsInputDateEra) Valid() bool {
	switch e {
	case OrgSettingsInputDateEraBE:
		return true
	case OrgSettingsInputDateEraCE:
		return true
	default:
		return false
	}
...
// Defines values for OrgSettingsInputDefaultLanguage.
const (
	OrgSettingsInputDefaultLanguageEn OrgSettingsInputDefaultLanguage = "en"
	OrgSettingsInputDefaultLanguageTh OrgSettingsInputDefaultLanguage = "th"
)

// Valid indicates whether the value is a known member of the OrgSettingsInputDefaultLanguage enum.
func (e OrgSettingsInputDefaultLanguage) Valid() bool {
	switch e {
	case OrgSettingsInputDefaultLanguageEn:
		return true
	case OrgSettingsInputDefaultLanguageTh:
		return true
	default:
		return false
	}
...
// Defines values for OrgGetSettingsParamsAcceptLanguage.
const (
	OrgGetSettingsParamsAcceptLanguageEn OrgGetSettingsParamsAcceptLanguage = "en"
	OrgGetSettingsParamsAcceptLanguageTh OrgGetSettingsParamsAcceptLanguage = "th"
)

// Valid indicates whether the value is a known member of the OrgGetSettingsParamsAcceptLanguage enum.
func (e OrgGetSettingsParamsAcceptLanguage) Valid() bool {
	switch e {
	case OrgGetSettingsParamsAcceptLanguageEn:
		return true
	case OrgGetSettingsParamsAcceptLanguageTh:
		return true
	default:
		return false
	}
...
// Defines values for OrgUpdateSettingsParamsAcceptLanguage.
const (
	OrgUpdateSettingsParamsAcceptLanguageEn OrgUpdateSettingsParamsAcceptLanguage = "en"
	OrgUpdateSettingsParamsAcceptLanguageTh OrgUpdateSettingsParamsAcceptLanguage = "th"
)

// Valid indicates whether the value is a known member of the OrgUpdateSettingsParamsAcceptLanguage enum.
func (e OrgUpdateSettingsParamsAcceptLanguage) Valid() bool {
	switch e {
	case OrgUpdateSettingsParamsAcceptLanguageEn:
		return true
	case OrgUpdateSettingsParamsAcceptLanguageTh:
		return true
	default:
		return false
	}
...
// OrgBranding defines model for OrgBranding.
...
type OrgSettings struct {
	...
	DateEra         OrgSettingsDateEra         `json:"date_era"`
	DefaultLanguage OrgSettingsDefaultLanguage `json:"default_language"`

	// RowVersion 0 means the tenant has never saved settings yet — these are the defaults
	RowVersion int `json:"row_version"`

	// UpdatedAt Absent when row_version is 0
	UpdatedAt *Timestamp `json:"updated_at,omitempty"`
}

// OrgSettingsDateEra defines model for OrgSettings.DateEra.
type OrgSettingsDateEra string

// OrgSettingsDefaultLanguage defines model for OrgSettings.DefaultLanguage.
type OrgSettingsDefaultLanguage string

// OrgSettingsInput defines model for OrgSettingsInput.
type OrgSettingsInput struct {
	Branding        *OrgBranding                    `json:"branding,omitempty"`
	DateEra         OrgSettingsInputDateEra         `json:"date_era"`
	DefaultLanguage OrgSettingsInputDefaultLanguage `json:"default_language"`
}

// OrgSettingsInputDateEra defines model for OrgSettingsInput.DateEra.
type OrgSettingsInputDateEra string

// OrgSettingsInputDefaultLanguage defines model for OrgSettingsInput.DefaultLanguage.
type OrgSettingsInputDefaultLanguage string
...
// OrgGetSettingsParams defines parameters for OrgGetSettings.
type OrgGetSettingsParams struct {
	// AcceptLanguage Language of messages and localized fields (default th)
	AcceptLanguage *OrgGetSettingsParamsAcceptLanguage `json:"Accept-Language,omitempty"`
}

// OrgGetSettingsParamsAcceptLanguage defines parameters for OrgGetSettings.
type OrgGetSettingsParamsAcceptLanguage string

// OrgUpdateSettingsParams defines parameters for OrgUpdateSettings.
type OrgUpdateSettingsParams struct {
	// AcceptLanguage Language of messages and localized fields (default th)
	AcceptLanguage *OrgUpdateSettingsParamsAcceptLanguage `json:"Accept-Language,omitempty"`

	// IfMatch ETag (row_version) of the resource being modified. Mismatch → 412, missing → 428.
	IfMatch IfMatch `json:"If-Match"`
}

// OrgUpdateSettingsParamsAcceptLanguage defines parameters for OrgUpdateSettings.
type OrgUpdateSettingsParamsAcceptLanguage string
...
// OrgUpdateSettingsJSONRequestBody defines body for OrgUpdateSettings for application/json ContentType.
type OrgUpdateSettingsJSONRequestBody = OrgSettingsInput
...
type ServerInterface interface {
	...
	// OrgGetSettings Default language, date era and branding for the tenant (ORG-20)
	// (GET /admin/v1/org/settings)
	OrgGetSettings(w http.ResponseWriter, r *http.Request, params OrgGetSettingsParams)
	// OrgUpdateSettings Change the tenant's default language, date era and branding
	// (PUT /admin/v1/org/settings)
	OrgUpdateSettings(w http.ResponseWriter, r *http.Request, params OrgUpdateSettingsParams)
...
// OrgGetSettings Default language, date era and branding for the tenant (ORG-20)
// (GET /admin/v1/org/settings)
func (_ Unimplemented) OrgGetSettings(w http.ResponseWriter, r *http.Request, params OrgGetSettingsParams) {
	w.WriteHeader(http.StatusNotImplemented)
}

// OrgUpdateSettings Change the tenant's default language, date era and branding
// (PUT /admin/v1/org/settings)
func (_ Unimplemented) OrgUpdateSettings(w http.ResponseWriter, r *http.Request, params OrgUpdateSettingsParams) {
	w.WriteHeader(http.StatusNotImplemented)
}
...
// OrgGetSettings operation middleware
func (siw *ServerInterfaceWrapper) OrgGetSettings(w http.ResponseWriter, r *http.Request) {

	var err error
	_ = err

	// Parameter object where we will unmarshal all parameters from the context
	var params OrgGetSettingsParams

	headers := r.Header

	// ------------- Optional header parameter "Accept-Language" -------------
	if valueList, found := headers[http.CanonicalHeaderKey("Accept-Language")]; found {
		var AcceptLanguage OrgGetSettingsParamsAcceptLanguage
		n := len(valueList)
		if n != 1 {
			siw.ErrorHandlerFunc(w, r, &TooManyValuesForParamError{ParamName: "Accept-Language", Count: n})
			return
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.OrgGetSettings(w, r, params)
	}))
...
// OrgUpdateSettings operation middleware
func (siw *ServerInterfaceWrapper) OrgUpdateSettings(w http.ResponseWriter, r *http.Request) {

	var err error
	_ = err

	// Parameter object where we will unmarshal all parameters from the context
	var params OrgUpdateSettingsParams

	headers := r.Header

	// ------------- Optional header parameter "Accept-Language" -------------
	if valueList, found := headers[http.CanonicalHeaderKey("Accept-Language")]; found {
		var AcceptLanguage OrgUpdateSettingsParamsAcceptLanguage
		n := len(valueList)
		if n != 1 {
			siw.ErrorHandlerFunc(w, r, &TooManyValuesForParamError{ParamName: "Accept-Language", Count: n})
			return
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.OrgUpdateSettings(w, r, params)
	}))
...
func HandlerWithOptions(si ServerInterface, options ChiServerOptions) http.Handler {
	...
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/admin/v1/org/settings", wrapper.OrgGetSettings)
	})
	r.Group(func(r chi.Router) {
		r.Put(options.BaseURL+"/admin/v1/org/settings", wrapper.OrgUpdateSettings)
	})
	r.Group(func(r chi.Router) {
...
type OrgGetSettingsRequestObject struct {
	Params OrgGetSettingsParams
}

type OrgGetSettingsResponseObject interface {
	VisitOrgGetSettingsResponse(w http.ResponseWriter) error
}

type OrgGetSettings200ResponseHeaders struct {
	ETag *string
}

type OrgGetSettings200JSONResponse struct {
	Body    OrgSettings
	Headers OrgGetSettings200ResponseHeaders
}

func (response OrgGetSettings200JSONResponse) VisitOrgGetSettingsResponse(w http.ResponseWriter) error {
...
type OrgGetSettings401ApplicationProblemPlusJSONResponse struct {
	UnauthorizedApplicationProblemPlusJSONResponse
}

func (response OrgGetSettings401ApplicationProblemPlusJSONResponse) VisitOrgGetSettingsResponse(w http.ResponseWriter) error {
...
type OrgGetSettings403ApplicationProblemPlusJSONResponse struct {
	ForbiddenApplicationProblemPlusJSONResponse
}

func (response OrgGetSettings403ApplicationProblemPlusJSONResponse) VisitOrgGetSettingsResponse(w http.ResponseWriter) error {
...
type OrgUpdateSettingsRequestObject struct {
	Params OrgUpdateSettingsParams
	Body   *OrgUpdateSettingsJSONRequestBody
}

type OrgUpdateSettingsResponseObject interface {
	VisitOrgUpdateSettingsResponse(w http.ResponseWriter) error
}

type OrgUpdateSettings200ResponseHeaders struct {
	ETag *string
}

type OrgUpdateSettings200JSONResponse struct {
	Body    OrgSettings
	Headers OrgUpdateSettings200ResponseHeaders
}

func (response OrgUpdateSettings200JSONResponse) VisitOrgUpdateSettingsResponse(w http.ResponseWriter) error {
...
type OrgUpdateSettings400ApplicationProblemPlusJSONResponse struct {
	BadRequestApplicationProblemPlusJSONResponse
}

func (response OrgUpdateSettings400ApplicationProblemPlusJSONResponse) VisitOrgUpdateSettingsResponse(w http.ResponseWriter) error {
...
type OrgUpdateSettings401ApplicationProblemPlusJSONResponse struct {
	UnauthorizedApplicationProblemPlusJSONResponse
}

func (response OrgUpdateSettings401ApplicationProblemPlusJSONResponse) VisitOrgUpdateSettingsResponse(w http.ResponseWriter) error {
...
type OrgUpdateSettings403ApplicationProblemPlusJSONResponse struct {
	ForbiddenApplicationProblemPlusJSONResponse
}

func (response OrgUpdateSettings403ApplicationProblemPlusJSONResponse) VisitOrgUpdateSettingsResponse(w http.ResponseWriter) error {
...
type OrgUpdateSettings412ApplicationProblemPlusJSONResponse struct {
	PreconditionFailedApplicationProblemPlusJSONResponse
}

func (response OrgUpdateSettings412ApplicationProblemPlusJSONResponse) VisitOrgUpdateSettingsResponse(w http.ResponseWriter) error {
...
type OrgUpdateSettings422ApplicationProblemPlusJSONResponse struct {
	UnprocessableEntityApplicationProblemPlusJSONResponse
}

func (response OrgUpdateSettings422ApplicationProblemPlusJSONResponse) VisitOrgUpdateSettingsResponse(w http.ResponseWriter) error {
...
type OrgUpdateSettings428ApplicationProblemPlusJSONResponse struct {
	PreconditionRequiredApplicationProblemPlusJSONResponse
}

func (response OrgUpdateSettings428ApplicationProblemPlusJSONResponse) VisitOrgUpdateSettingsResponse(w http.ResponseWriter) error {
...
type StrictServerInterface interface {
	...
	// OrgGetSettings Default language, date era and branding for the tenant (ORG-20)
	// (GET /admin/v1/org/settings)
	OrgGetSettings(ctx context.Context, request OrgGetSettingsRequestObject) (OrgGetSettingsResponseObject, error)
	// OrgUpdateSettings Change the tenant's default language, date era and branding
	// (PUT /admin/v1/org/settings)
	OrgUpdateSettings(ctx context.Context, request OrgUpdateSettingsRequestObject) (OrgUpdateSettingsResponseObject, error)
	// OrgListUnits The org-unit tree in path order (parents before children) (ORG-04)
	// (GET /admin/v1/org/units)
...
// OrgGetSettings operation middleware
func (sh *strictHandler) OrgGetSettings(w http.ResponseWriter, r *http.Request, params OrgGetSettingsParams) {
	var request OrgGetSettingsRequestObject

	request.Params = params

	handler := func(ctx context.Context, w http.ResponseWriter, r *http.Request, request interface{}) (interface{}, error) {
		return sh.ssi.OrgGetSettings(ctx, request.(OrgGetSettingsRequestObject))
	}
	for _, middleware := range sh.middlewares {
		handler = middleware(handler, "OrgGetSettings")
	}
	...
	if err != nil {
		sh.options.ResponseErrorHandlerFunc(w, r, err)
	} else if validResponse, ok := response.(OrgGetSettingsResponseObject); ok {
		if err := validResponse.VisitOrgGetSettingsResponse(w); err != nil {
			sh.options.ResponseErrorHandlerFunc(w, r, err)
		}
	} else if response != nil {
		sh.options.ResponseErrorHandlerFunc(w, r, fmt.Errorf("unexpected response type: %T", response))
...
// OrgUpdateSettings operation middleware
func (sh *strictHandler) OrgUpdateSettings(w http.ResponseWriter, r *http.Request, params OrgUpdateSettingsParams) {
	var request OrgUpdateSettingsRequestObject

	request.Params = params

	var body OrgUpdateSettingsJSONRequestBody
	if err := json.NewDecoder(r.Body).Decode(&body); err != nil {
		sh.options.RequestErrorHandlerFunc(w, r, fmt.Errorf("can't decode JSON body: %w", err))
		return
	}
	...
	handler := func(ctx context.Context, w http.ResponseWriter, r *http.Request, request interface{}) (interface{}, error) {
		return sh.ssi.OrgUpdateSettings(ctx, request.(OrgUpdateSettingsRequestObject))
	}
	for _, middleware := range sh.middlewares {
		handler = middleware(handler, "OrgUpdateSettings")
	}
	...
	if err != nil {
		sh.options.ResponseErrorHandlerFunc(w, r, err)
	} else if validResponse, ok := response.(OrgUpdateSettingsResponseObject); ok {
		if err := validResponse.VisitOrgUpdateSettingsResponse(w); err != nil {
			sh.options.ResponseErrorHandlerFunc(w, r, err)
		}
	} else if response != nil {
		sh.options.ResponseErrorHandlerFunc(w, r, fmt.Errorf("unexpected response type: %T", response))
